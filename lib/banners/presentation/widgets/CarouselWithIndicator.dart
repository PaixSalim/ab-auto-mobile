...
class _CarouselWithIndicatorState extends State<CarouselWithIndicator> {
  ...
  Widget build(BuildContext context) {
    final double carouselWidth = MediaQuery.of(context).size.width * 0.95;
    return Column(
      children: [
                  ...
                  if (state is RemoteBannerError) {
                    CarouselSlider(
                      ...
                      options: CarouselOptions(
                        ...
                        enlargeCenterPage: false,
                        viewportFraction:
                            0.9, // Occupe 90% de la largeur de l'écran
                        enlargeStrategy:
                            CenterPageEnlargeStrategy
                                .height, // Agrandit en hauteur
                        aspectRatio: 16 / 6,
                        padEnds:
                            false, // Pas d'espace supplémentaire au début et à la fin
                        scrollDirection: Axis.horizontal,
                        onPageChanged: (index, reason) {
                          setState(() {
                            _currentIndex = index;
